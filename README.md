...
> The following project was carried out with the purpose of create a product landing page about the systems development.
...
Feel free to check the [issues page](https://github.com/aristides1000/product-landing-page-freecode-camp/issues).
